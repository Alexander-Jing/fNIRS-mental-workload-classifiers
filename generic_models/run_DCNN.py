...
parser.add_argument('--n_epoch', default=600, type=int, help="number of epoch")
...
def train_classifier(args_dict, train_subjects, val_subjects, test_subjects):
    ...
    for lr in lrs:
        for dropout in dropouts:
            ...
            criterion = nn.NLLLoss() #for EEGNet、DeepConvNet and DCNN, use nn.NLLLoss directly, which accept integer labels
